...
BEGIN TRANSACTION;
CREATE TABLE users(user_id INTEGER PRIMARY KEY AUTOINCREMENT,                                    nickname TEXT UNIQUE, regDate INTEGER,                                    lastLogin INTEGER, timesviewed INTEGER,                                    UNIQUE(user_id, nickname));
...
CREATE TABLE users_profile(                    user_id INTEGER PRIMARY KEY,                    firstname TEXT,                    lastname TEXT,                    email TEXT,                    website TEXT,                    picture TEXT,                    mobile TEXT,                    skype TEXT,                    age INTEGER,                    residence TEXT,                    gender TEXT,                    signature TEXT,                    avatar TEXT,                    FOREIGN KEY(user_id) REFERENCES users(user_id)                        ON DELETE CASCADE,                    UNIQUE(user_id)                    );
